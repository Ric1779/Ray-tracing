...
class camera{
            ...
            for (int j = 0; j < image_height; ++j) {
                ...
                for (int i = 0; i < image_width; ++i) {
                    ...
                    for (int sample = 0; sample < samples_per_pixel; ++sample) {
                        ray r = get_ray(i, j);
                        pixel_color += ray_color_old(r, max_depth, world);
                    }
    ...
    private:
        ...
        color ray_color_old(const ray& r, int depth, const hittable& world) const {
            hit_record rec;
            ...
            if (world.hit(r, interval(0.001, infinity), rec)) {
                ...
                if (rec.mat->scatter(r, rec, attenuation, scattered))
                    return attenuation * ray_color_old(scattered, depth-1, world);
                return color(0,0,0);
            }
